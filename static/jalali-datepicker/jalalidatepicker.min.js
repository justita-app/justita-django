...
var Mh1PersianDatePicker = function () {
    ...
    this.show = function (textBox, holidays) {
        ...
        currentJalaliTime = farvardin.gregorianToSolar(m_today.getUTCFullYear() , m_today.getUTCMonth() + 1 , m_today.getDate() , "array")

        _today = currentJalaliTime.join('/');
        _textBox = textBox;
